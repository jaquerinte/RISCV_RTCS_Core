...
void Vprocessor::traceFullThis__1(Vprocessor__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
    ...
    // Body
    {
	vcdp->fullBit(c+1,((1U & (((1U & (((IData)(vlTOPp->processor__DOT__inst_IF__DOT__inst_hcf__DOT__output_xor_4) 
					   >> 5U) ^ 
	...
	vcdp->fullBus(c+10,((7U & (((IData)(vlTOPp->processor__DOT__inst_IF__DOT__inst_hcf__DOT__output_xor_4) 
